...
class Author(TimestampMixin):
    ...
    name = fields.CharField(max_length=62)

    books: fields.ReverseRelation["Book"]

    class Meta:
        table_description = "作家"
        table = "author"


class Book(TimestampMixin):
    id = fields.IntField(pk=True)
    book_name = fields.CharField(max_length=62)

    author: fields.ForeignKeyRelation[Author] = fields.ForeignKeyField("base.Author", related_name="books")

    class Meta:
        table_description = "图书"
        table = "book"
